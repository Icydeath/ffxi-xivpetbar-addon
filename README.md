# xivpetbar
This addon was created by combining pettp and xivbar addons (with modifications to both addons code)

This addon displays pet vital bars for easy tracking
...
2. Edit the addon's settings file: **_Windower4\addons\xivpetbar\data\settings.xml_**
3. Save the file 
4. Press Insert in FFXI to access the windower console 
5. Type ``` lua r xivpetbar ``` to reload the addon
6. Press Insert in FFXI again to close the windower console

## How to create my own custom theme
1. Create a folder inside the *theme* directory of the addon: **_Windower4\addons\xivpetbar\themes\MY_CUSTOM_THEME_**
